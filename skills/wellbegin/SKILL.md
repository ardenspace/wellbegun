...
- This lens **is** the idea-shaping stage of the pipeline. If the environment carries other plugins' idea-shaping or planning skills, do not invoke them while this skill is active — double-running a stage corrupts it.
