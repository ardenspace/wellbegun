...
Turn the approved spec into a phase > step structure where every step carries a contract written **before any implementation exists**. The output is `.wellbegun/plan.md`.
