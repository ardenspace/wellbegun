...
|---|---|---|---|
| **S** | Minutes, inside one file; nobody else notices. | Variable naming, internal helper structure, copy text, a private function's shape. | Implementer decides silently. No record needed. |
